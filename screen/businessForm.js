                            ...
                            <Content contentContainerStyle={styles.content}>
                                <View>
                                    ...
                                    <TouchableHighlight onPress={() => { this.setImage() }} style={{ alignItems: 'center', justifyContent: 'center', marginTop: heightPercentageToDP('10%'), }}>
                                        <ImageBackground style={{ width: widthPercentageToDP('100%'), height: 250, zIndex: 900, backgroundColor: 'grey', justifyContent: 'center', alignItems: 'center' }} source={imgSource ? imgSource : require('../img/b1.jpg')} >
                                    ...
                                    <View style={styles.Time}>
                                        <View style={styles.box}>
                                            <TouchableOpacity onPress={() => this.toggle(1)}>
                                                ...
                                                <Text style={{ flex: 8, fontFamily: 'Roboto', fontWeight: '500', fontStyle: 'normal', fontSize: widthPercentageToDP('5') }}>{Time1_startTime ? moment(Time1_startTime).format('HH:mm A') : '--:--'}</Text>
                                            </TouchableOpacity>
                                        </View>
                                        <View style={styles.box}>
                                            <TouchableOpacity onPress={() => { this.toggle(2) }}>
                                                ...
                                                <Text style={{ flex: 8, fontFamily: 'Roboto', fontWeight: '500', fontStyle: 'normal', fontSize: widthPercentageToDP('5') }}>{Time1_endTime ? moment(Time1_endTime).format('HH:mm A') : '--:--'}</Text>
                                            </TouchableOpacity>
                                        </View>
                                    </View>
                                </View>
                                    ...
                                    <View style={styles.Time}>
                                        <View style={styles.box}>
                                            <TouchableOpacity onPress={() => { this.toggle(3) }}>
                                                <Text style={{ flex: 6, fontFamily: 'Roboto', fontWeight: '700', fontStyle: 'normal', fontSize: widthPercentageToDP('4') }}>Start time</Text>
                                                <Text style={{ flex: 8, fontFamily: 'Roboto', fontWeight: '500', fontStyle: 'normal', fontSize: widthPercentageToDP('5') }}>{Time2_startTime ? moment(Time2_startTime).format('HH:mm A') : '--:--'}</Text>
                                            </TouchableOpacity>
                                        </View>
                                        <View style={styles.box}>
                                    ...
                                    <View style={styles.Time}>
                                        <View style={styles.box}>
                                            <TouchableOpacity onPress={() => this.toggle(5)}>
                                                <Text style={{ flex: 6, fontFamily: 'Roboto', fontWeight: '700', fontStyle: 'normal', fontSize: widthPercentageToDP('4') }}>Start time</Text>
                                                <Text style={{ flex: 8, fontFamily: 'Roboto', fontWeight: '500', fontStyle: 'normal', fontSize: widthPercentageToDP('5') }}>{aTime1_startTime ? moment(aTime1_startTime).format('HH:mm A') : '--:--'}</Text>
                                            </TouchableOpacity>
                                        </View>
                                        <View style={styles.box}>
                                            <TouchableOpacity onPress={() => { this.toggle(6) }}>
                                                <Text style={{ flex: 6, fontFamily: 'Roboto', fontWeight: '700', fontStyle: 'normal', fontSize: widthPercentageToDP('4') }}>End time</Text>
                                                <Text style={{ flex: 8, fontFamily: 'Roboto', fontWeight: '500', fontStyle: 'normal', fontSize: widthPercentageToDP('5') }}>{aTime1_endTime ? moment(aTime1_endTime).format('HH:mm A') : '--:--'}</Text>
                                            </TouchableOpacity>
                                        </View>
                                    </View>
                                </View>
                                    ...
                                    <View style={styles.Time}>
                                        <View style={styles.box}>
                                            <TouchableOpacity onPress={() => { this.toggle(7) }}>
                                                <Text style={{ flex: 6, fontFamily: 'Roboto', fontWeight: '700', fontStyle: 'normal', fontSize: widthPercentageToDP('4') }}>Start time</Text>
                                                <Text style={{ flex: 8, fontFamily: 'Roboto', fontWeight: '500', fontStyle: 'normal', fontSize: widthPercentageToDP('5') }}>{aTime2_startTime ? moment(aTime2_startTime).format('HH:mm A') : '--:--'}</Text>
                                            </TouchableOpacity>
                                        </View>
                                        <View style={styles.box}>
                                            <TouchableOpacity onPress={() => { this.toggle(8) }}>
                                                <Text style={{ flex: 6, fontFamily: 'Roboto', fontWeight: '700', fontStyle: 'normal', fontSize: widthPercentageToDP('4') }}>End time</Text>
                                                <Text style={{ flex: 8, fontFamily: 'Roboto', fontWeight: '500', fontStyle: 'normal', fontSize: widthPercentageToDP('5') }}>{aTime2_endTime ? moment(aTime2_endTime).format('HH:mm A') : '--:--'}</Text>
                                            </TouchableOpacity>
                                        </View>
                                    </View>
                                </View> : null}
